...
abstract class HybridMultipleImagePickerSpec: HybridObject() {
  ...
  @DoNotStrip
  @Keep
  abstract fun openCamera(config: NitroCameraConfig, resolved: (result: Result) -> Unit, rejected: (reject: Double) -> Unit): Unit
  
  @DoNotStrip
  @Keep
  private fun openCamera(config: NitroCameraConfig, resolved: Func_void_Result, rejected: Func_void_double): Unit {

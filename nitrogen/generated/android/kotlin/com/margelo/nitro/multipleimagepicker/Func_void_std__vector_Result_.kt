///
/// Func_void_std__vector_Result_.kt
...
class Func_void_std__vector_Result_ {
  @DoNotStrip
  @Keep
   ...
   */
  fun toLambda(): (result: Array<Result>) -> Unit = this::call
   ...
   */
  @FastNative
  external fun call(result: Array<Result>): Unit
}

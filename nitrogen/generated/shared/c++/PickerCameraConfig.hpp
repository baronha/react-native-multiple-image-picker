...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    explicit PickerCameraConfig(CameraDevice cameraDevice, std::optional<double> videoMaximumDuration): cameraDevice(cameraDevice), videoMaximumDuration(videoMaximumDuration) {}
  };
